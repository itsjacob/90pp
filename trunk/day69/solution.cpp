...
public:
  ListNode *mergeKLists(vector<ListNode *> &lists)
  {
    ...
    // if the list in the vector container is single element, then this is basically merge sort, which takes O(KlogK)
    // since the element in the vector can be of size N, the total cost is O(NKlogK) since we need to walk
